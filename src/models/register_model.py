...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='rraghu59015', repo_name='Swiggy-Delivery-Time-Prediction', mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/rraghu59015/Swiggy-Delivery-Time-Prediction.mlflow")
